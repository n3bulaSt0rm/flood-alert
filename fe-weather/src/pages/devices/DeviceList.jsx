          ...
          <div className="flex items-center bg-gray-100 mb-10 shadow" key={device.id}>
            <button onClick={() => handleOnClick(device.id)}>
              <div className="flex-auto text-left px-4 py-2 m-2">
                ...
                <span className="inline-block text-sm font-semibold mt-1">{device?.location?.name}</span>
              </div>
            </button>
            <div className="flex-auto text-right px-4 py-2 m-2">
              ...
              <button title="Remove" onClick={(e) => handleDeleteDevice(e, device.id)} className="block bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded-full inline-flex items-center">
